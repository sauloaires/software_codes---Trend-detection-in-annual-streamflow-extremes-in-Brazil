...
/*import org.snirh.extremos_unb.deteccao.gui.FrameResultadoEstacionaridade;
import org.snirh.extremos_unb.deteccao.gui.GuiResulEstac;
import org.snirh.extremos_unb.deteccao.gui.PanelResultEstacTable;
import org.snirh.extremos_unb.deteccao.gui.PanelTestesEstatisticos;
import org.snirh.extremos_unb.deteccao.gui.GuiResulEstac.executarTabelaResultados;
...
public class GuiResulEstac extends JPanel {

	private static final long serialVersionUID = 1L;
	
   private JTabbedPane tabResults;
   
   private PanelResultEstacTable panelResultEstacTable;
   private SimulationDataExtremos simulationData;
   private FrameResultadoEstacionaridade frm;
   private PanelTrendDetectionStreamflowBrazil pnt;
   
   
   public  GuiResulEstac(SimulationDataExtremos simulationData){
   ...
   //	this.tabResults.addTab("Estatística", this.panelEstatistics);
	...
	public  GuiResulEstac(SimulationDataExtremos simulationData,PanelTrendDetectionStreamflowBrazil pnt,FrameResultadoEstacionaridade frm){
		   this.simulationData = simulationData;
		   this.pnt=pnt;
		   this.frm=frm;
	   ...
	   private void createAndShowGUI(PanelTrendDetectionStreamflowBrazil pnt,FrameResultadoEstacionaridade frm) {		
		this.setBackground(Color.LIGHT_GRAY);
	  	this.setLayout(new BorderLayout());
		...
		private void formatPanels(PanelTrendDetectionStreamflowBrazil pnt,FrameResultadoEstacionaridade frm){
	   	this.tabResults = new JTabbedPane();
	   	this.tabResults.setBackground(this.getBackground());
	   	this.tabResults.setBorder(new EtchedBorder());
	   	this.tabResults.setBounds(0, 0, 550, 300);
	   	
	   	 executarTabelaResultados exeModProb= new executarTabelaResultados(this.simulationData,this.pnt,this,this.tabResults,this.panelResultEstacTable, frm);
		...
		class executarTabelaResultados extends SwingWorker<Void, String> {
			...
			private PanelResultEstacTable panelResultEstacTable;
			private JTabbedPane tabResults;
			private GuiResulEstac guiresgraf;
			private FrameResultadoEstacionaridade frm;
			private int iestfim;
			
			public executarTabelaResultados (SimulationDataExtremos simulationData,PanelTrendDetectionStreamflowBrazil pnt,GuiResulEstac guiresgraf,JTabbedPane tabResults,PanelResultEstacTable panelResultEstacTable,FrameResultadoEstacionaridade frm){
